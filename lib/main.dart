...
import 'package:game1/score.dart';

void main() {
  runApp(LetterClickChallengeApp());
}

class LetterClickChallengeApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Letter Click Challenge',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: LetterClickGameScreen(),
    );
  }
}
...
class _LetterClickGameScreenState extends State<LetterClickGameScreen> {
  ...
  void initState() {
    super.initState();
    flutterTts.isLanguageAvailable("en-US").then((available) {
  ...
  Future<void> _onLetterClicked(String letter) async {
    setState(() async {
